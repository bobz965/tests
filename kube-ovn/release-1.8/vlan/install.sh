...
POD_CIDR="10.120.13.0/24"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="10.120.13.254"
...
EXCLUDE_IPS="10.120.13.1..10.120.13.200"                         # EXCLUDE_IPS for default subnet
