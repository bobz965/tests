...
POD_CIDR="10.16.10.0/24"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="10.16.10.1"
SVC_CIDR="10.96.10.0/24"                # Do NOT overlap with NODE/POD/JOIN CIDR
JOIN_CIDR="100.64.10.0/24"              # Do NOT overlap with NODE/POD/SVC CIDR
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: kube-ovn-controller
          image: "registry.yealinkops.com/third_party/kolla/l1-kube-ovn-controller:v0.0.42"
          imagePullPolicy: $IMAGE_PULL_POLICY
          command:
