...
POD_CIDR="10.123.0.0/16"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="10.123.0.1"
SVC_CIDR="10.124.0.0/16"                # Do NOT overlap with NODE/POD/JOIN CIDR
...
if [ "$IPV6" = "true" ]; then
  POD_CIDR="fd00:10:123::/64"                # Do NOT overlap with NODE/SVC/JOIN CIDR
  POD_GATEWAY="fd00:10:123::1"
  SVC_CIDR="fd00:10:124::/112"               # Do NOT overlap with NODE/POD/JOIN CIDR
  JOIN_CIDR="fd00:100:64::/64"              # Do NOT overlap with NODE/POD/SVC CIDR
  PINGER_EXTERNAL_ADDRESS="2400:3200::1"
  PINGER_EXTERNAL_DOMAIN="google.com"
fi
if [ "$DUAL_STACK" = "true" ]; then
  POD_CIDR="10.123.0.0/16,fd00:10:123::/64"                # Do NOT overlap with NODE/SVC/JOIN CIDR
  POD_GATEWAY="10.123.0.1,fd00:10:123::1"
  SVC_CIDR="10.124.0.0/12,fd00:10:124::/112"               # Do NOT overlap with NODE/POD/JOIN CIDR
  ...
  PINGER_EXTERNAL_DOMAIN="baidu.com"
...
USED_CONTAINERD_HOSTS_COUNTS=$(kubectl  get node -A -owide | grep "containerd://" | wc -l)
while true; do
  if [ "$USED_CONTAINERD_HOSTS_COUNTS" \> "0" ]; then
  echo "Tips: If it is the first time to deploy kube-ovn in this cluster, please confirm after you restart containerd service on all nodes."
