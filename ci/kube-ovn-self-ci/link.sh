...
ln -s kube-ovn-self-ci/005-build-l1-kube-ovn-daemon.sh 005-build-l1-kube-ovn-daemon.sh
...
ln -s kube-ovn-self-ci/05-l1-kube-ovn-daemon-dockerfile 05-l1-kube-ovn-daemon-dockerfile
